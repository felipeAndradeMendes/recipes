...
// describe('componente Recipes in Progress', () => {
//   test('renderiza as informações receita corretamente', async () => {
//     const history = createMemoryHistory();
//     const { getByTestId } = render(
//       <Router path="/meals/52977/in-progress" history={ history }>
//         <RecipeContext.Provider value={ { showRecipeInProgress: mealsMock } }>
//           <HeaderProvider>
//             <SearchBarProvider>
//               <App />
//             </SearchBarProvider>
